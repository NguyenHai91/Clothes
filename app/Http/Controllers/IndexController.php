...
class IndexController extends Controller
{
	...
	public function postProductDetail($id, Request $request)
	{
		...
		Cart::add(['id'=>$productDetail, 'name'=>$productBuy['name'],'qty'=>$request['txtQuant'],'price'=>$productBuy['price'],'options'=>['image'=>$productBuy['image'], 'size' => $request->slcSize, 'color'=>$request->slcColor]]);

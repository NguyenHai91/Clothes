...
class IndexController extends Controller
{
	...
	public function postProductDetail($id, Request $request)
	{
		...
		Cart::add(['id'=>$id, 'name'=>$productBuy['name'],'qty'=>$request['txtQuant'],'price'=>$productBuy['price'],'options'=>['image'=>$productBuy['image'], 'size' => $size['size'], 'color'=>$color['name'], 'detail' => $productDetail]]);

			...
			<form method="post" action="">
				...
				<fieldset>
					<div class="clearfix">
						...
						<div class="input">
							<input tabindex="1" size="18" id="name" name="txtName" type="text" value="{{old('txtName',isset($user)? $user->username : '')}}" class="input-xlarge" placeholder="Name">
						</div>
					</div>
					...
					<div class="clearfix">
						...
						<div class="input">
							<input tabindex="2" size="25" id="email" name="txtEmail" type="text" value="{{old('txtName',isset($user)? $user->email : '')}}" class="input-xlarge" placeholder="Email Address">
						</div>
					</div>
					...
					<div class="clearfix">
						...
						<div class="input">
							<textarea tabindex="3" class="input-xlarge" id="message" name="txtMessage" rows="7" placeholder="Message"></textarea>
						</div>
					</div>
